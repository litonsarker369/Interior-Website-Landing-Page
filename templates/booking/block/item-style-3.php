         ...
         <?php 
            ...
            if($discount || $featured){
               echo '<div class="item-labels">';
                  if($discount){
                     echo '<span class="item-label item-discount">' . esc_html($discount) . '% ' . esc_html__( 'off', 'gowilds' ) . '</span>';
                  }
                  if($featured){
                     echo '<span class="item-label item-featured">' . esc_html__( 'Featured', 'gowilds' ) . '</span>';
                  }
               echo '</div>';   
            }
         ?>
